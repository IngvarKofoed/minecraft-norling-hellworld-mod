package norling.hellworld.world.generation.chunks;
	                    ...
	                    for (int i2 = 0; i2 < 8; ++i2)
	                    {
	                        ...
	                        for (int j2 = 0; j2 < 4; ++j2)
	                        {
	                            ...
	                            for (int k2 = 0; k2 < 4; ++k2)
	                            {
	                                ...
	                                if (d15 > 0.0D)
	                                {
	                                	double blockType = this.rand.nextDouble();
	                                	if (blockType > 0.5) 
	                                	{
	                                		iblockstate = MAIN_BLOCK1;	
	                                	}
	                                	else if (blockType > 0.95)
	                                	{
	                                		iblockstate = MAIN_BLOCK2;
	                                	}
	                                	else 
	                                	{
	                                		iblockstate = MAIN_BLOCK3;
	                                	}
	                                }
	    ...
	    public void buildSurfaces(int x, int z, ChunkPrimer primer)
	    {
	        ...
	        for (int j = 0; j < 16; ++j)
	        {
	            for (int k = 0; k < 16; ++k)
	            {
	                ...
	                int i1 = -1;
	                IBlockState iblockstate = MAIN_BLOCK1;
	                IBlockState iblockstate1 = MAIN_BLOCK1;
	                ...
	                for (int j1 = 127; j1 >= 0; --j1)
	                {
	                    if (j1 < 127 - this.rand.nextInt(5) && j1 > this.rand.nextInt(5))
	                    {
	                        ...
	                        {
	                            if (iblockstate2.getBlock() == MAIN_BLOCK1.getBlock())
	                            {
	                                if (i1 == -1)
	                                {
	                                    if (l <= 0)
